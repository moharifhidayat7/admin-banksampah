            ...
            <div className="flex px-4  lg:h-24 lg:px-24 justify-between items-center">
               <div className="flex">
                  ...
                  <div className="hidden lg:flex">
                     <button className="font-sans focus:outline-none focus:border-pink-500  text-xl border-b-2 border-transparent mr-10 hover:border-pink-500 transform hover:scale-105 py-1">
                        Pembelian
                     </button>
