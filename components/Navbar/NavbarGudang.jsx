      ...
      <div>
         <div className="top-0 w-full bg-blue-800 lg:bg-white">
            <div className="flex px-4  lg:h-24 lg:px-24 justify-between items-center">
               <div className="flex">
                  ...
                  <div className="hidden lg:flex">
                     ...
                     <a role='button' className="font-sans focus:outline-none focus:border-pink-500  text-xl border-b-2 border-transparent mr-10 hover:border-pink-500 transform hover:scale-105 py-1">
                        Pembelian
                     </a></Link>
                     <Link href='/Client/Gudang/Penjualan'>
                     <a role='button' className="font-sans focus:outline-none focus:border-pink-500  text-xl border-b-2 border-transparent hover:border-pink-500 transform hover:scale-105 py-1">
                        Penjualan
                     </a></Link>
                  </div>
               </div>
            ...
            <div className="lg:hidden shadow-lg flex w-full bg-white px-4 border-b-2">
               ...
               <Link href='/Client/Gudang/Pembelian'>
                  <a role='button' className="py-0.5 px-4 focus:outline-none border-b-2 border-transparent  focus:border-pink-500 flex flex-col items-center">
               ...
               <Link href='/Client/Gudang/Penjualan'>
                  <a role='button' className="py-0.5 px-4 focus:outline-none border-b-2 border-transparent focus:border-pink-500 flex flex-col items-center">
                     ...
                     <span className="uppercase font-mono">Jual</span>
                  </a></Link>
               </div>
               <div className="border-r">
               <Link href='/Admin/Gudang/'>
