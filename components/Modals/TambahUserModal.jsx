          ...
          <div className='p-5'>
            <div>
              ...
              >
                ...
                <option value='bendahara'>Admin Bendahara</option>
                <option value='penjualan'>Admin Penjualan</option>
                <option value='client_gudang'>Client Gudang</option>
                <option value='client_bendahara'>Client Bendahara</option>
                <option value='client_penjualan'>Client Penjualan</option>
              </select>
              {errors.role && (
            ...
            <div className='mt-2'>
              <label>
                Password{" "}
                {edit._id ? "" : <span className='text-red-500'>*</span>}
              </label>
              {edit._id ? (
                <input
                  name='password'
            ...
            <div className='mt-2'>
              ...
              {edit._id ? (
                ...
                <input
                  ...
                  type='password2'
                  className={`block border w-full px-4 py-1 ${
                    errors.password2 && "border-red-500 border-2"
                  }`}
                  ref={register({
                    validate: (value) =>
                      value === password.current || "Password tidak sesuai",
                  })}
                />
              )}
              {errors.password2 && (
