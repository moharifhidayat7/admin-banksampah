      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='bg-white shadow-md m-4 lg:grid lg:grid-cols-3 lg:gap-4  rounded-sm p-2 space-y-4'>
          <div className='space-y-4 lg:col-span-1'>
            <h3 className='flex text-gray-800 lg:hidden'>Penjualan Sampah</h3>
          ...
          <div className='flex flex-col lg:col-span-2 space-y-5 '>
            <h3 className='lg:flex text-gray-800 hidden'>Penjualan Sampah</h3>
                  ...
                  {items.map((item) => {
                    return (
                      <TableRow key={item._sampahType._id}>
                        ...
                        <TableCell>
                          <label>{formatRp(item.price)}</label>
                        </TableCell>
