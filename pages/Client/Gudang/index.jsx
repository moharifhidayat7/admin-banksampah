...
export default function Pembelian({ sampahType }) {
  ...
  const handleSelect = (e) => {
    const tipe = sampahType.results.filter(
        ...
        <div className='bg-white shadow-md m-4 lg:grid lg:grid-cols-3 lg:gap-4  rounded-sm p-2 space-y-4'>
            ...
            <CardGudang title='Informasi Nota'>
              ...
              <div className='p-2'>
                <div className='flex  justify-between items-center'>
                  ...
                  >
                    <option value='TABUNG' disabled={cash ? "disabled" : ""}>
                      TABUNG
                    </option>
                ...
                <AsyncCreatableSelect
                  ...
                  onChange={(e) => {
                    if (e.__isNew__) {
                      ...
                      setValue("_nasabah.address", e.address);
                      setValue("_nasabah.mobile", e.mobile);
                    }
                  }}
          ...
          <div className='flex flex-col  lg:col-span-2 space-y-5'>
            <div className='lg:flex hidden lg:justify-between'>
              <h3 className='flex text-gray-800 font-bold'>Pembelian Sampah</h3>
            </div>
                  ...
                  {items.map((item) => {
                    return (
                      <TableRow key={item._sampahType._id}>
                        <TableCell>
                          <label>{item._sampahType.name}</label>
                        </TableCell>
                        <TableCell>
                          <label>
                        ...
                        <TableCell>
                          <label>
                            {formatRp(item._sampahType.price * item.qty)}
                          </label>
                        </TableCell>
                        <TableCell className='float-right'>
                          <button
                            ...
                            onClick={(e) => {
                              e.preventDefault();
                              handleDelete(item._sampahType._id);
                            }}
                          >
                            <Icons.X />
                          </button>
            ...
            <div>
              ...
              {success ? (
                <div className='flex justify-end mt-2 space-x-10'>
                  ...
                  <Link href={`/Client/Gudang/Pembelian/${trx}`}>
                    <a
                      target='_blank'
