import ClientLayout from "../../../components/Layouts/ClientBendahara";
         ...
         <div className="grid grid-cols-3 gap-8">
            <div className="col-span-2 relative">
               ...
               <div className="grid grid-cols-2 grid-rows-2 gap-4 h-full">
                           ...
                           sampahPurchase.cash.reduce((total, trx) => {
                              return (
                                 ...
                                 trx.items.reduce((tot, item) => {
                                    return (
                                       tot + item._sampahType.price * item.qty
                                    );
                                 }, 0)
                              );
                           }, 0)
                  ...
                  <div className="p-5 ring-1 bg-gray-100 text-center rounded-lg">
                     ...
                     <div className="text-2xl">
                        {formatRp(
                           sampahPurchase.tabung.reduce((total, trx) => {
                              return (
                                 total +
                                 trx.items.reduce((tot, item) => {
                                    return (
            ...
            <div className="">
               ...
               <div className="space-y-4">
                  ...
                  >
                     <span className="align-middle">Tabung/Tarik Tunai</span>
                  </button>
                  <button
                     onClick={toggleModal}
                  ...
                  <button className="text-white px-2 focus:outline-none block w-full py-3 bg-yellow-500 hover:bg-yellow-800 uppercase font-medium rounded-lg">
                     <span className="align-middle">Transaksi Internal</span>
                  </button>
               </div>
            </div>
         </div>
