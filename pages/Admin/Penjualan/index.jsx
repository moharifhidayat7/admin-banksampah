...
export default function Index({ products, orders }) {
  ...
  useEffect(() => {
    setProduct(products.results.length);
    setPemasukan(() => {
      return orders.results.reduce((total, item) => {
    ...
    <PenjualanLayout>
      <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-4'>
        ...
        <DashboardCard
          ...
          icon={<CollectionOutline className='text-yellow-500' size='100%' />}
          title='Produk di Etalase'
