    ...
    <AdminLayout>
      <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4'>
        <DashboardCard
          ...
          icon={<SwitchVerticalOutline className='text-red-500' size='100%' />}
          title='Total Pengeluaran Tunai'
          value='Rp. 353365959'
        />
        <DashboardCard
          borderColor='border-green-400'
          icon={<CashOutline className='text-green-500 text-5xl' size='100%' />}
            ...
            <div>
              <div className='flex items-center space-x-5 px-5 py-2 bg-yellow-100 border-gray border-b'>
                <div className='flex-grow'>
                  <small className='font-bold'>Jemput Sampah</small>
                  <span className='text-xs ml-2 text-gray'>
                    2 jam yang lalu
                  </span>
                  <div>
                    <small>
                      Dusun Kampunganyar RT 02 RW 05 Desa Gumuk, Kecamatan Licin
                    </small>
                  </div>
                </div>
