      ...
      <div>
        <div className='bg-white rounded shadow m-auto md:w-10/12 w-full'>
          <div className='border-b px-4 py-2 flex justify-between	'>
            <h3 className='font-semibold text-lg'>Detail Pembelian Sampah</h3>
          </div>
          <div className='p-5'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
              ...
              <div>
                ...
                <div>
                  <label className='font-bold'> Tanggal Pembelian : </label>
                  <label>
                    {new Date(sampahPurchase.createdAt).toLocaleString(
                      "id-ID",
                      {
                        year: "numeric",
                        month: "long",
          ...
          <div className='flex justify-between items-center w-full border-t p-5'>
            <div>
              ...
              <span className='font-bold text-md'>{formatRp(total)}</span>
            </div>
            <div>
              <button
              ...
              <button
                ...
                onClick={() => delTransaction(sampahPurchase._id)}
              >
                Hapus
              </button>
            </div>
